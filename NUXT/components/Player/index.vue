...
import sabr from "@/plugins/sabr/sabr";
...
// Sort by bitrate audio
  ...
  methods: {
    ...
    _sabrStartMse(mediaSource, mimeType, streamParams, signal, existingSourceBuffer = null) {
      return sabr._sabrStartMse(this, mediaSource, mimeType, streamParams, signal, existingSourceBuffer);
    },

    async loadVideoViaSabr(selectedFormat = null, startTimeSec = 0) {
      return sabr.loadVideoViaSabr(this, selectedFormat, startTimeSec);
    },
